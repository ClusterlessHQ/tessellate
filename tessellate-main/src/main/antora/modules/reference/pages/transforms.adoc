...
Def:::
- `^fixedWidth{width:...,indentAt:...} ->` - replace ALL fields with the fixed with result
- `^fixedWidth{width:...,indentAt:...} -> new_field|type + new_field2|type + etc` - name the new fields
Params:::
